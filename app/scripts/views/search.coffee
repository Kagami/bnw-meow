...
SearchItemView = require "views/search_item"
DatePickerView = require "views/base/datepicker"
utils = require "lib/utils"
template = require "templates/search"
notFound = require "templates/no_search_items"

module.exports = class SearchView extends ScrollableView
  container: "#main"
  template: template
  listSelector: "#search"
