...
describe "Formatters", ->
  ...
  describe "Markdown", ->
    ...
    it "should insert images previews", ->
      f("img: ![test](http://example.com/1.jpg)").should.equal('<p>img: <span class="preview"><a href="http://example.com/1.jpg"><img src="https://uglyhx.appspot.com/thumb?img=http%3A%2F%2Fexample.com%2F1.jpg" alt="test"></a></span></p>\n')
      f("img: ![Test][id]\n[id]: http://example.com/1.gif").should.equal('<p>img: <span class="preview preview-gif"><a href="http://example.com/1.gif"><img src="https://uglyhx.appspot.com/thumb?img=http%3A%2F%2Fexample.com%2F1.gif" alt="Test"></a></span></p>\n')
